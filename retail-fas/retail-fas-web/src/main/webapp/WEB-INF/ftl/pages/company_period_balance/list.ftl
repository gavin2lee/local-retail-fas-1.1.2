...
<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/modules/cost/companyPeriodBalance.js?version=${version}"></script>
</head>
<body class="easyui-layout">
	<div data-options="region:'north',border:false" class="toolbar-region">
	     <@p.toolbar id="toolbar" listData=[
             ...
             {"id":"btn-ok","title":"生成对账差异报表","iconCls":"icon-ok","action":"showDialog()", "type":0},
        	...
        	<div data-options="region:'center',border:false">
		      <@p.datagrid id="dataGridDiv" loadUrl="" saveUrl="" defaultColumn=""  
		              isHasToolBar="false" onClickRowEdit="false" pagination="true" checkOnSelect="true" selectOnCheck="true"
					   ...
					   frozenColumns="[
									{title : '冻结属性',width: 120,align:'left',halign:'center',colspan:'5'},
					   			  ],
					   			  [
			           ...
			           columnsJsonList="[
			                      ...
			                      {title : '基础属性',width: 80,align:'left',halign:'center',colspan:'10'},
				                  {title : '期初',colspan:'6'},
			                  	  {title : '期间入',colspan:'11'},
			                  	  {title : '期间出',colspan:'8'},
			                 	  {title : '期间',colspan:'4'},
			                  	  {title : '期末',colspan:'11'}
			                  	  ],
	...
	<div id="generateDiffFormPanel" class="easyui-dialog" data-options="closed:true"> 
	     <form name="generateDiffForm" id="generateDiffForm" method="post"  >
	     	<div>
				 <table class="form-tb">
            	    <col width="120px"/>
            	 	<col />
                    <tbody>
                       <tr>
                            ...
                            <td><input class="ipt"  multiSearch="company" data-options="required:true"/><input type="hidden" name="companyNo" /></td>
					   </tr>
                       <tr>
						   <th><span class="ui-color-red">*</span>品牌部：</th>
						   <td><input  class="ipt"  multiSearch="brandUnit" data-options="required:true"/><input type="hidden" name="brandNo"/></td>
					   </tr>
					   <tr>
					   <tr>
						    <th><span class="ui-color-red">*</span>年份：</th>
							<td><input class="ipt" name="year" id="yearDiffCondition" data-options="required:true" /></td>
					   </tr>
					   <tr>
						    <th><span class="ui-color-red">*</span>月份：</th>
							<td><input class="ipt" name="month" id="monthDiffCondition" data-options="required:true" /></td>
					   </tr>
					 </tbody>
				 </table>
			</div>

...
<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/modules/cost/storeBalanceReport.js?version=${version}"></script>
</head>
			      	...
			      	<form name="searchForm" id="searchForm" method="post">
						<table class="form-tb">
							...
							<tbody>
								...
								<!--	<th><span class="ui-color-red">*</span>年份：</th>
							 		<td>
							 			<input class="easyui-combobox" data-options="required:true,inputWidth:160"   name="year" id="yearCondition" data-options="minDate:'sendStartDate'" />
							 		</td>
									...
									<th>货管单位：</th>
							 		<td>
								 		...
								 		data-options="multiple:'true',inputWidth:160,inputNoField:'orderUnitNoCondition',inputNameField:'orderUnitNameCondition'"/>
				      					<input type="hidden" name="orderUnitNos" id="orderUnitNoCondition"/>
			      					</td>
			      					<th>机构：</th>
							 		<td>
								...
								<tr>
									...
									<th>显示小计： </th>
								 	<td>
								 		<input type="checkbox"  name="isSubTotal" id="isSubTotal" />
								 	</td>
						 		</tr>
							</tbody>
						</table>
						<table class="form-tb">
							...
							<tr>
								...
								<th>机构：<input type="checkbox" name="isCheckShopNo" id="isCheckShopNo" value="1"/></th>
								<th>性别：<input type="checkbox" name="isCheckGender" id="isCheckGender" value="1"/></th>
								<th>品牌部：<input type="checkbox" name="isCheckBrandUnit" id="isCheckBrandUnit" value="1"/></th>
								<th>大类：<input type="checkbox" name="isCheckCategory" id="isCheckCategory" value="1"/></th>
								<th>中类：<input type="checkbox" name="isCheckRootCategory" id="isCheckRootCategory" value="1"/></th>
								<th>年份：<input type="checkbox" name="isCheckYear" id="isCheckYear" value="1"/></th>
								<th>季节：<input type="checkbox" name="isCheckSellSeason" id="isCheckSellSeason" value="1"/></th>
							</tr>
						</table>
					</form>
				</div>
        	...
        	<div data-options="region:'center',border:false">
		      <@p.datagrid id="dataGridDiv" loadUrl="" saveUrl="" defaultColumn=""  
		              isHasToolBar="false" onClickRowEdit="false" pagination="true" checkOnSelect="true" selectOnCheck="true"
					   ...
					   frozenColumns="[
					   			  {title : '冻结属性',width: 150,align:'left',halign:'center',colspan:'4'},
					   		],[
				                  {field : 'itemCode',title : '商品编码',width: 150,align:'left',halign:'center'},
				                  {field : 'itemName',title : '商品名称',width: 200,align:'left',halign:'center'},
			           ...
			           columnsJsonList="[
			                  	  ...
			                  	  {title : '基础属性',colspan:'14'},
			                  	  {title : '期初',colspan:'2'},
			                  	  {title : '期间入',colspan:'14'},
				               ...
				               [
				                  ...
				                  {field : 'yearsName',title : '商品年份',width: 80,align:'center'},

...
<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/modules/cost/regionPriceRule.js?version=${version}"></script>
</head>
<body class="easyui-layout">
	<@p.commonSetting search_url="/region_price_rule/list.json" 
					  save_url="/region_price_rule/insert" 
					  update_url="/region_price_rule/update" 
					  del_url="/region_price_rule/save" 
					  datagrid_id="dataGridDiv" 
					  search_form_id="searchForm" 
					  data_form_id="dataForm"
					  dialog_width="680" 
					  dialog_height="460"
					  export_url="/region_price_rule/do_fas_export"
					  export_title="地区加价规则导出"
					  primary_key="id"/>
	...
	<div data-options="region:'north',border:false" class="toolbar-region">
	     <@p.toolbar id="toolbar" listData=[
             ...
             {"id":"btn-edit1","title":"增加年份","iconCls":"icon-edit","action":"regionPriceRule.addYear()","type":2},
						...
						<col width="100"/>
		                 ...
		                 <tbody>
						 	<tr>
						 		...
						 		<th>供应商组名称：</th>
						 		<td>
						 			<input class="ipt" name="supplierGroupNoAlial" id="supplierGroupNoCondition" />
						 		</td>
						 		<th>新旧款类型：</th>
						 		<td>
						 			<input class="ipt" name="styleType" id="styleTypeCondition" />
						 		</td>
						 		<th>年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;份：</th>
						 		<td>
						 			<input class="ipt" name="yearCode" id="yearCodeCondition" />
						 		</td>
						 	</tr>
							<tr>
								<th>地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;区：</th>
						 		<td>
						 			<input class="easyui-combobox ipt" name="zoneNoAlial" id="zoneNoCondition" />
						 		</td>
								<th>加价依据：</th>
						 		<td>
						 			<input class="ipt" name="addBasis" id="addBasisCondition" />
						 		</td>
						 		<th>生效日期：</th>
							 	<td>
							...
							<tr>
			        		    ...
			        		    <td>
						 	    ...
						 	    <th>季&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;节：</th>
						 		<td>
						 			<input class="ipt" name="season" id="seasonCondition" />
						 		</td>
						 		<th></th>
						 		<td></td>
						 	</tr>
		      ...
		      <@p.datagrid id="dataGridDiv"  loadUrl="" saveUrl=""   defaultColumn=""   
		              isHasToolBar="false"    onClickRowEdit="false"    pagination="true"  checkOnSelect="true" selectOnCheck="true"
			           ...
			           columnsJsonList="[
				                  ...
				                  {field : 'addBasis',title : '加价依据',width: 100,align:'center',formatter:regionPriceRule.addBasisFormatter},
				                  {field : 'zoneName',title : '地区',width: 100,align:'left',halign:'center'},
				          ...
				          jsonExtend='{onDblClickRow:function(rowIndex, rowData){
			           	  		 regionPriceRule.loadDetail(rowData);
			              }}'
                 />
			</div>
	 	</div>
	...
	<div id="myFormPanel" class="easyui-dialog" data-options="closed:true"> 
				...
				<div id="div1" class="easyui-panel" style="width:620px;"  title="识别信息" data-options="title:'识别信息',fieldset:true,cls:'mt10'">
					<table cellpadding="1" cellspacing="1" class="form-tb">
				         ...
				         <tbody>
				         	<tr height="40">
				         		<th>规则编码：</th>
			        		    <td><input class="easyui-validatebox ipt" style="width:150px" name="addRuleNo" id="addRuleNo" data-options="required:true,validType:['engNum','maxLength[18]']"/></td>
				         		<th>供应商组：</th>
			        		...
			        		<tr height="40">
			        			...
			        			<th>是否新旧款：</th>
			        		    <td>
									<input type="radio" name="newStyleFlag" style="width:50px" value="1" id="radio1" />是
									&nbsp;&nbsp;
									<input type="radio" name="newStyleFlag" style="width:50px" value="0" id="radio0" />否
								<td>
							</tr>
			        		<tr height="40">
			        			<th>新旧款类型：</th>
			        		    <td><input class="ipt" name="styleType" id="styleType" /></td>
			        		    <th>年份：</th>
			        		    <td>
			        		...
			        		<tr height="40">
			        			<th>季节：</th>
			        		    <td>
			        		    	<input class="ipt" name="season" id="season" />
			        		    	<input type="hidden" name="seasonName" id="seasonName" />
			        		    </td>
				         		<th>加价依据：</th>
			        		    <td><input class="ipt" name="addBasis" id="addBasis" data-options="required:true,onSelect: regionPriceRule.bindAddBasisEvent" /></td>
			        		</tr>
			        		<tr height="40">
			        			<th>加价：</th>
			        		...
			        		<tr height="40">
			        		    ...
			        		    <th>地区：</th>
			        		    <td><input class="ipt" name="zoneNos" id="zoneNos" data-options="required:true,validType:'length[1,50]'"/><input type="hidden" name="zoneName" id="zoneName" /></td>
			        		</tr>
			        		<tr height="40">
			        		    <th>二级大类：</th>
       ...
       <div id="addYearFormPanel" class="easyui-dialog" data-options="closed:true"> 
	     <form name="addYearForm" id="addYearForm" method="post" class="pd10">
	     	<div id="dtl_detail2">
				<div id="div2" class="easyui-panel" title="识别信息" data-options="title:'识别信息',fieldset:true,cls:'mt10'">
					<table cellpadding="1" cellspacing="1" class="form-tb">
					   <tr height="40">
					   		<th><span class="ui-color-red">*</span>增加年份：</th>
	        		    	<td>
		        		    	<input class="ipt" name="yearCode" id="addYearCode" />
		        		    	<input type="hidden" name="year" id="addYear" />
		        		    </td>
					   </tr>
					</table>
				</div>
